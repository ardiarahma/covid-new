...
<body>
		...
		<div class="navbar navbar-inverse navbar-transparent" id="navbar-second" style="background-color:#1a2c43">
			...
			<div class="navbar-collapse collapse" id="navbar-second-toggle">
				<ul class="nav navbar-nav navbar-nav-material">
					...
					<li><a href="{{url('/info-grafik-diy')}}">Infografis</a></li>
				</ul>
			</div>
		</div>
		<!-- /second navbar -->
	...
	<div style="margin-top: -20px;">
		<div class="panel-flat bg-slate">
			<div class="panel-body text-center" style="background-color:#073c64">
				<h1 style="font-family:sans-serif;font-size:30px">Peta Sebaran Kasus COVID-19 di Gunungkidul</h1>
			</div>
		</div>
	</div>
	<!-- /content area -->
							...
							<div class="col-md-12 text-center">
								<div class="col-md-10 col-md-offset-1">
									<div style="margin:5px">
										<span>
											<p style="text-align:left">Peta persebaran tersebut diharapkan dapat
												memberikan informasi kepada masyarakat. Disamping itu angka persebaran
												ini harapan kami dapat dijadikan kewaspadaan kita. Tetapi ini <b>tidak
													menunjukkan zona merah</b>. Karena secara epidemiologis wilayah DIY
												ini adalah wilayah yang padat, tidak tepisahkan, sehingga jangan
												dimaknai bahwa hanya kecamatan yang ada kasus yg perlu waspada.</p>
											<p style="text-align:left">Harapan kami semua masyarakat di Kabupaten
												Gunungkidul tetap waspada dan tidak panik, tetapi mengikuti arahan
												Pemerintah Kabupaten Gunungkidul bahwa mengurangi keluar rumah bila
												tidak penting, mengurangi berkumpul dengan banyak orang, rajin melakukan
												cuci tangan dengan sabun dan air mengalir, meningkatkan stamina tubuh
												dengan perilaku hidup bersih dan sehat.</p>
										</span>
									</div>
									...
									<div class='tableauPlaceholder' id='viz1590199712140' style='position: relative'>
										<noscript><a href='https:&#47;&#47;corona.gunungkidulkab.go.id&#47;'>
												<img alt=' '
													src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;da&#47;datacovid-19-22052020&#47;Dashboard2&#47;1_rss.png'
													style='border: none' /></a>
										</noscript>
										<object class='tableauViz' style='display:none;'>
											...
											<param name='embed_code_version' value='3' />
											<param name='path'
												value='views&#47;datacovid-19-22052020&#47;Dashboard2?:embed=y&amp;:toolbar=yes&amp;:embed_code_version=3&amp;:loadOrderID=1&amp;:display_count=yes&amp;:tabs=no' />
											<param name='toolbar' value='yes' />
											<param name='static_image'
												value='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;da&#47;datacovid-19-22052020&#47;Dashboard2&#47;1.png' />
											<param name='animate_transition' value='yes' />
											<param name='display_static_image' value='yes' />
											<param name='display_spinner' value='yes' />
											<param name='display_overlay' value='yes' />
											<param name='display_count' value='yes' />
											<param name='tabs' value='no' /></object>
									</div>
									<div style="margin:5px;padding-top:5px">
										<h5 style="text-align:left">Sumber: Dinas Kesehatan Kabupaten Gunungkidul</h5>
							...
							<div class="content">
								...
								<form class="form-horizontal form-validate-jquery" method="POST"
									...
									<div class="panel panel-body login-form">
										...
										<div class="text-center">
											<h5 class="content-group"><b style="color:#073c64">KKN-PPM UGM 2020 - UNIT
													BEDOYO</b></h5>
	...
	<script type='text/javascript'>
		var divElement = document.getElementById('viz1590199712140'); var vizElement = divElement.getElementsByTagName('object')[0]; if (divElement.offsetWidth > 800) { vizElement.style.width = '1124px'; vizElement.style.height = '900px'; } else if (divElement.offsetWidth > 500) { vizElement.style.width = '900px'; vizElement.style.height = '4250px'; } else { vizElement.style.width = '100%'; vizElement.style.height = '900px'; } var scriptElement = document.createElement('script'); scriptElement.src = 'https://public.tableau.com/javascripts/api/viz_v1.js'; vizElement.parentNode.insertBefore(scriptElement, vizElement);
	</script>
</body>
